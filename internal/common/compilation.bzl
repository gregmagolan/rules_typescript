...
load("@build_bazel_rules_nodejs//:providers.bzl", "JSModuleInfo", "JSNamedModuleInfo", "JSEcmaScriptModuleInfo", "transitive_js_module_info", "transitive_js_named_module_info", "transitive_js_ecma_script_module_info")
